...
public:
    ...
    //! \e minimumSeperationMsec, in which case it is delay or ignored, depending on the
    //! value of \e option.
    //! Otherwise, the action is performed synchronously.
    ...
    //!
    //! Meaningful only if \e option is \c Delay.
    //!
